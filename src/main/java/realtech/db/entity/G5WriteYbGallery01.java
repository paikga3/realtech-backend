...
/**
 * The persistent class for the g5_write_yb_gallery01 database table.
 * 
 */
@Entity
@Table(name="g5_write_yb_gallery01")
@NamedQuery(name="G5WriteYbGallery01.findAll", query="SELECT g FROM G5WriteYbGallery01 g")
public class G5WriteYbGallery01 implements Serializable {
