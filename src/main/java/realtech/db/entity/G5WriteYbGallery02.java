...
/**
 * The persistent class for the g5_write_yb_gallery02 database table.
 * 
 */
@Entity
@Table(name="g5_write_yb_gallery02")
@NamedQuery(name="G5WriteYbGallery02.findAll", query="SELECT g FROM G5WriteYbGallery02 g")
public class G5WriteYbGallery02 implements Serializable {
